...
<head>
    ...
    <meta name="description" content="Servicio profesional de mantenimiento y reparación automotriz con más de 15 años de experiencia">
...
<body>
    ...
    <section class="hero">
        <div class="hero-inner">
            <h1>Reparación y Mantenimiento Automotriz Profesional</h1>
            <p class="hero-subtitle">Servicios confiables con más de 15 años de experiencia</p>
        ...
        <div class="services-inner">
            ...
            <div class="services-grid">
                <div class="service-box">
                    ...
                    <p>Servicios completos de reparación, diagnóstico y mantenimiento preventivo con técnicos certificados.</p>
                    <a href="#soluciones" class="service-link">Explorar →</a>
                </div>
                <div class="service-box">
                    <h3>Diagnóstico Electrónico</h3>
                    <p>Diagnosis computarizada de sistemas eléctricos y electrónicos con equipos de última generación.</p>
                    <a href="#soluciones" class="service-link">Explorar →</a>
                </div>
            </div>
        </div>
            ...
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://res.cloudinary.com/dcfodug6m/image/upload/v1768881736/WhatsApp_Image_2026-01-19_at_8.46.46_PM_je6mv6.jpg" alt="Reparación de motor">
                    ...
                    <div class="carousel-item">
                        <img src="https://res.cloudinary.com/dcfodug6m/image/upload/v1768881857/WhatsApp_Image_2026-01-19_at_8.47.39_PM_wgqejr.jpg" alt="Cambio de neumáticos">
                        <div class="carousel-caption">
                            <h4>Reparación BDC2</h4>
                            <p>Reparación BDC2 BMW G01 después de programación abortada se restauró y funcionado al 💯</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="https://res.cloudinary.com/dcfodug6m/image/upload/v1768882416/WhatsApp_Image_2026-01-19_at_8.48.17_PM_e0p4f2.jpg" alt="Diagnóstico electrónico">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="https://res.cloudinary.com/dcfodug6m/image/upload/v1768882560/WhatsApp_Image_2026-01-19_at_8.49.29_PM_mr3mzj.jpg" alt="Mantenimiento">
                        <div class="carousel-caption">
...
<section id="videos" class="videos-section">
    <div class="videos-container">
        ...
        <div class="videos-grid">
            <div class="video-card">
                <div class="video-wrapper">
                    <video class="video-player" width="100%" height="100%" controls >
                        <source src="https://res.cloudinary.com/dcfodug6m/video/upload/v1768883590/WhatsApp_Video_2026-01-19_at_10.30.39_PM_jax7da.mp4" type="video/mp4">
            ...
            <div class="video-card">
                <div class="video-wrapper">
                    <video class="video-player" width="100%" height="100%" controls >
                        <source src="https://res.cloudinary.com/dcfodug6m/video/upload/v1768883995/WhatsApp_Video_2026-01-19_at_10.39.03_PM_x3oskq.mp4" type="video/mp4">
    ...
    <section class="brands">
        <div class="brands-inner">
            ...
            <div class="brand-item">Honda</div>
            <div class="brand-item">Mazda</div>
            <div class="brand-item">Hyundai</div>
            <div class="brand-item">Chevrolet</div>
            <div class="brand-item">Kia</div>
            <div class="brand-item">Tesla</div>
            ...
            <div class="stories-grid">
                <div class="story-card">
                    <div class="story-quote">
                        <p>"Excelente servicio, técnicos muy profesionales. Mi vehículo quedó como nuevo. Sin duda volveré a confiar en ustedes."</p>
                    </div>
                ...
                <div class="story-card">
                    <div class="story-quote">
                        <p>"Servicio rápido, eficiente y honesto. El personal es transparente en sus diagnósticos. Muy recomendado para cualquiera que cuide su inversión."</p>
                    </div>
                    <div class="story-author">
                        <div class="author-info">
                ...
                <div class="story-card">
                    <div class="story-quote">
                        <p>"Llevo 5 años trayendo mis vehículos aquí. Buen equipamiento, técnicos profesionales, precios justos. Confío plenamente en TECNIMECANICA CALIFORNIA."</p>
                    </div>
                    <div class="story-author">
                        <div class="author-info">
    ...
    <section class="about">
        <div class="services-container">
            ...
            <div class="about-content">
                <p>Ofrecemos reparaciones automotrices garantizadas, respaldado por más de 15 años de experiencia y un compromiso constante con la innovación. Mantenemos tu vehículo en las mejores condiciones con herramientas y equipos de alta tecnología.</p>
                
                <p>Nuestro personal constantemente capacitado se especializa en el mantenimiento, diagnóstico y corrección de fallas en automóviles modernos. Contamos con un equipo multidisciplinario que puede atender desde vehículos particulares hasta flotillas empresariales.</p>
                
                <p>En TECNIMECANICA CALIFORNIA, tu confianza es nuestra prioridad. Ofrecemos transparencia total, precios justos y garantía en todos nuestros servicios. ¡Somos el taller que necesitas!</p>
            </div>
        </div>
    </section>
